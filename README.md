...
组件：8 个 `/cmdb_*` 命令、11 个 `cmdb-control` MCP 工具、5 个子 Agent（planner / coder / tester / build-checker / reviewer）、3 个生命周期 Hook、1 个 Skill、Obsidian 投影模板与 GitHub Actions 模板。
...
- 低、中风险自动合并同样要求服务端 Required PR Checks 存在且成功；
