...
Obsidian is read-only. Recommended local projections: `00_Dashboard/研发控制台.md`, `01_Requirements/`, `02_Bugs/`, `.cmdb-dev/state.json`. Prefer keeping them out of product-code commits.
